...
def main():
    parser = argparse.ArgumentParser(description="A simple flashcard quiz game")
    parser.add_argument("--num_cards", type=int, default=len(cards), help="Number of flashcards to use (default: all)")
